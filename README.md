## launch (jazzy) - 3.4.12-1

The packages in the `launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy launch` on `Fri, 18 Sep 2026 22:07:39 -0000`
...
- rosdistro version: `3.4.11-1`
- old version: `3.4.11-1`
- new version: `3.4.12-1`
...
## launch (kilted) - 3.8.9-1

The packages in the `launch` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted launch` on `Fri, 18 Sep 2026 22:04:17 -0000`
...
## launch (humble) - 1.0.15-1

The packages in the `launch` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble launch` on `Mon, 07 Sep 2026 18:05:49 -0000`
...
## launch (rolling) - 3.10.1-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling launch` on `Wed, 02 Sep 2026 07:47:58 -0000`
...
## launch (kilted) - 3.8.8-1

The packages in the `launch` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted launch` on `Tue, 14 Jul 2026 13:30:53 -0000`
...
## launch (lyrical) - 3.9.8-1

The packages in the `launch` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical launch` on `Tue, 14 Jul 2026 13:25:29 -0000`
...
## launch (jazzy) - 3.4.11-1

The packages in the `launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy launch` on `Tue, 02 Jun 2026 05:58:51 -0000`
...
- upstream repository: https://github.com/ros2/launch.git
- release repository: https://github.com/ros2-gbp/launch-release.git
- rosdistro version: `3.4.10-1`
- old version: `3.4.10-1`
- new version: `3.4.11-1`
...
## launch (rolling) - 3.10.0-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release -r rolling -t rolling launch` on `Thu, 07 May 2026 18:45:37 -0000`
...
## launch (rolling) - 3.9.7-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling launch` on `Thu, 09 Apr 2026 09:21:27 -0000`
...
- upstream repository: https://github.com/ros2/launch.git
- release repository: https://github.com/ros2-gbp/launch-release.git
- rosdistro version: `3.4.9-1`
- old version: `3.4.9-1`
- new version: `3.4.10-1`
...
## launch (kilted) - 3.8.7-1

The packages in the `launch` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted launch` on `Mon, 12 Jan 2026 13:46:49 -0000`
...
## launch (rolling) - 3.9.6-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling launch` on `Mon, 12 Jan 2026 13:38:58 -0000`
...
## launch (humble) - 1.0.13-1

The packages in the `launch` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble launch` on `Fri, 07 Nov 2025 11:21:26 -0000`
...
## launch (jazzy) - 3.4.9-1

The packages in the `launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy launch` on `Fri, 07 Nov 2025 09:33:41 -0000`
...
## launch (kilted) - 3.8.6-1

The packages in the `launch` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted launch` on `Fri, 07 Nov 2025 09:27:57 -0000`
...
## launch (rolling) - 3.9.5-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling launch` on `Fri, 07 Nov 2025 08:58:35 -0000`
...
## launch (humble) - 1.0.12-1

The packages in the `launch` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble launch` on `Fri, 17 Oct 2025 10:13:01 -0000`
...
## launch (jazzy) - 3.4.8-1

The packages in the `launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy launch` on `Fri, 17 Oct 2025 10:05:55 -0000`
...
## launch (kilted) - 3.8.5-3

The packages in the `launch` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted launch` on `Fri, 17 Oct 2025 09:59:26 -0000`
...
## launch (kilted) - 3.8.5-2

The packages in the `launch` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted launch` on `Fri, 17 Oct 2025 09:44:01 -0000`
...
## launch (kilted) - 3.8.5-1

The packages in the `launch` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted launch` on `Fri, 17 Oct 2025 09:41:49 -0000`
...
## launch (rolling) - 3.9.4-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling launch` on `Fri, 17 Oct 2025 09:36:01 -0000`
...
## launch (jazzy) - 3.4.7-1

The packages in the `launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy launch` on `Mon, 06 Oct 2025 16:19:58 -0000`
...
## launch (kilted) - 3.8.4-1

The packages in the `launch` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted launch` on `Mon, 06 Oct 2025 16:14:32 -0000`
...
## launch (humble) - 1.0.11-1

The packages in the `launch` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble launch` on `Mon, 06 Oct 2025 12:01:57 -0000`
...
## launch (rolling) - 3.9.3-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling launch` on `Mon, 06 Oct 2025 11:56:45 -0000`
...
## launch (humble) - 1.0.10-2

The packages in the `launch` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble launch` on `Mon, 06 Oct 2025 11:51:05 -0000`
...
## launch (kilted) - 3.8.3-1

The packages in the `launch` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted launch` on `Thu, 11 Sep 2025 14:34:29 -0000`
...
## launch (jazzy) - 3.4.6-1

The packages in the `launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy launch` on `Wed, 06 Aug 2025 13:54:03 -0000`
...
## launch (rolling) - 3.9.2-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling launch` on `Tue, 29 Jul 2025 21:19:47 -0000`
...
## launch (humble) - 1.0.10-1

The packages in the `launch` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble launch` on `Wed, 16 Jul 2025 18:19:27 -0000`
...
## launch (jazzy) - 3.4.5-1

The packages in the `launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy launch` on `Mon, 23 Jun 2025 15:12:07 -0000`
...
## launch (kilted) - 3.8.2-1

The packages in the `launch` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted launch` on `Mon, 23 Jun 2025 15:07:02 -0000`
...
## launch (rolling) - 3.9.1-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling launch` on `Thu, 19 Jun 2025 11:54:47 -0000`
...
## launch (humble) - 1.0.9-1

The packages in the `launch` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble launch` on `Fri, 06 Jun 2025 20:11:42 -0000`
...
## launch (rolling) - 3.9.0-1

The packages in the `launch` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release launch -r rolling` on `Thu, 24 Apr 2025 19:41:04 -0000`
...
## launch (rolling) - 3.8.1-1

The packages in the `launch` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release launch -r rolling` on `Fri, 18 Apr 2025 18:53:17 -0000`
...
## launch (jazzy) - 3.4.4-1

The packages in the `launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy launch` on `Wed, 02 Apr 2025 14:32:41 -0000`
...
## launch (humble) - 1.0.8-1

The packages in the `launch` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble -y launch` on `Tue, 25 Mar 2025 13:16:50 -0000`
...
## launch (rolling) - 3.8.0-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling launch` on `Thu, 27 Feb 2025 09:58:27 -0000`
...
## launch (rolling) - 3.7.1-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling launch` on `Fri, 20 Dec 2024 16:23:13 -0000`
...
## launch (jazzy) - 3.4.3-1

The packages in the `launch` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy launch` on `Wed, 18 Dec 2024 07:19:02 -0000`
...
## launch (rolling) - 3.6.1-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling launch` on `Mon, 29 Jul 2024 15:07:16 -0000`
...
## launch (rolling) - 3.6.0-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling launch` on `Tue, 25 Jun 2024 17:55:19 -0000`
...
The packages in the `launch` repository were released into the `iron` distro by running `/usr/bin/bloom-release --rosdistro iron --track iron launch` on `Mon, 24 Jun 2024 09:16:47 -0000`
...
## launch (rolling) - 3.5.1-1

The packages in the `launch` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling launch` on `Mon, 17 Jun 2024 14:39:06 -0000`
